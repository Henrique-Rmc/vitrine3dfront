    ...
    <>
      <div className="max-w-2xl">
        ...
        {!isLoadingTypes && productTypes.length === 0 && (
          <div className="flex items-start gap-3 rounded-xl bg-warning-bg border border-warning-border px-4 py-4 text-sm text-warning-text mb-6">
            <svg className="w-5 h-5 shrink-0 mt-0.5 text-warning-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {saveError && <ErrorBanner icon>{saveError}</ErrorBanner>}
