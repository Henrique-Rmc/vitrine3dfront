  ...
  return (
    <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-12">
      <div className="mb-8">
        ...
        <p className="text-sm text-ink-3 mt-1">Última atualização: junho de 2025</p>
      </div>

      <div className="prose prose-stone max-w-none text-sm text-ink leading-relaxed space-y-6">

        <section>
          <h2 className="text-base font-bold text-ink mb-2">1. Natureza da Plataforma</h2>
          <p>
        ...
        <section>
          <h2 className="text-base font-bold text-ink mb-2">2. Isenção de Responsabilidade pelo Vendedor</h2>
          <p>
        ...
        <section>
          <h2 className="text-base font-bold text-ink mb-2">3. Responsabilidades do Lojista</h2>
        ...
        <section>
          <h2 className="text-base font-bold text-ink mb-2">4. Conteúdo e Propriedade Intelectual</h2>
          <p>
        ...
        <section>
          <h2 className="text-base font-bold text-ink mb-2">5. Canal de Denúncias</h2>
          <p>
        ...
        <section>
          <h2 className="text-base font-bold text-ink mb-2">6. Suspensão e Encerramento de Contas</h2>
          <p>
        ...
        <section>
          <h2 className="text-base font-bold text-ink mb-2">7. Limitação de Responsabilidade</h2>
          <p>
        ...
        <section>
          <h2 className="text-base font-bold text-ink mb-2">8. Alterações nos Termos</h2>
          <p>
        ...
        <section>
          <h2 className="text-base font-bold text-ink mb-2">9. Foro e Legislação</h2>
          <p>
