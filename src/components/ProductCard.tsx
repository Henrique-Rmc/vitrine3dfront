  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-square overflow-hidden bg-surface-2">
        ...
        <button
          onClick={handleShare}
          className="absolute top-2 right-2 w-7 h-7 flex items-center justify-center rounded-full bg-black/30 hover:bg-black/50 text-white shadow-sm transition-colors z-10"
