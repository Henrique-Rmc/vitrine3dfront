...
export default function AdminLayout() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100 flex">
      ...
      {/* Content column (offset on desktop to clear sidebar) */}
      <div className="flex-1 flex flex-col min-w-0 md:ml-60">
        ...
        {/* Page content — pb-24 to clear mobile bottom nav */}
      ...
      {/* Mobile bottom nav */}
      <nav className="md:hidden fixed bottom-0 left-0 right-0 z-30 bg-zinc-900 border-t border-zinc-800 h-16 flex items-stretch">
